...
Scanner::Scanner(char* stackStartPtr,SPRSmartPtr<SPRFile> eingabeDatei_i){
   ...
   dateiVollGelesen=0;
   SPRStackArrayConcrete<char,2> spr_StringScratch2b;strcpy(spr_StringScratch2b._array,"");
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   tokenWert=::new String_16(stackStartPtr,spr_StringScratch2b);
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
...
Scanner::Scanner(char* stackStartPtr,SPRSmartPtr<String_16> quellei){
   ...
   quelle=quellei;
   dateiVollGelesen=0;
   SPRStackArrayConcrete<char,2> spr_StringScratch2c;strcpy(spr_StringScratch2c._array,"");
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   tokenWert=::new String_16(stackStartPtr,spr_StringScratch2c);
   leseZeiger=0;
   CT=T_UNGUELTIG;
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
...
enum Token Scanner::nextToken(char* stackStartPtr){
   ...
   if(dateiVollGelesen==1){
      CT=T_DATEI_ENDE;
      if(debug){
         SPRStackArrayConcrete<char,14> spr_StringScratch2d;strcpy(spr_StringScratch2d._array,"T_DATEI_ENDE");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   ...
   do{
      if(this->istLeerzeichen(stackStartPtr,aktuellesZeichen)==1){
         if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
            ...
            CT=T_DATEI_ENDE;
            if(debug){
               SPRStackArrayConcrete<char,14> spr_StringScratch2e;strcpy(spr_StringScratch2e._array,"T_DATEI_ENDE");
               pfc.fstr(stackStartPtr,spr_StringScratch2e).pr(stackStartPtr);
   ...
   if(aktuellesZeichen==13){
      ...
      if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
         ...
         CT=T_DATEI_ENDE;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch2f;strcpy(spr_StringScratch2f._array,"T_DATEI_ENDE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      if(aktuellesZeichen=='\n'){
         ...
         CT=T_NEUE_ZEILE;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch30;strcpy(spr_StringScratch30._array,"T_NEUE_ZEILE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      {
      SPRStackArrayConcrete<char,40> spr_StringScratch31;strcpy(spr_StringScratch31._array,"einzelnes \\r gefunden. Beende Scanner");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   ...
   switch(aktuellesZeichen){
      case 'a':case 'b':case 'c':case 'd':case 'e':case 'f':case 'g':case 'h':case 'i':case 'j':case 'k':case 'l':case 'm':case 'n':case 'o':case 'p':case 'q':case 'r':case 's':case 't':case 'u':case 'v':case 'w':case 'x':case 'y':case 'z':case 'A':case 'B':case 'C':case 'D':case 'E':case 'F':case 'G':case 'H':case 'I':case 'J':case 'K':case 'L':case 'M':case 'N':case 'O':case 'P':case 'Q':case 'R':case 'S':case 'T':case 'U':case 'V':case 'W':case 'X':case 'Y':case 'Z':{
         ...
         do{
            if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
               ...
               CT=T_WORT;
               if(debug){
                  SPRStackArrayConcrete<char,8> spr_StringScratch33;strcpy(spr_StringScratch33._array,"T_WORT");
         ...
         CT=T_WORT;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch34;strcpy(spr_StringScratch34._array,"T_WORT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '(':{
         ...
         CT=T_KLAMMER_AUF;
         if(debug){
            SPRStackArrayConcrete<char,15> spr_StringScratch35;strcpy(spr_StringScratch35._array,"T_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ')':{
         ...
         CT=T_KLAMMER_ZU;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch36;strcpy(spr_StringScratch36._array,"T_KLAMMER_ZU");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '[':{
         ...
         if(debug){
            SPRStackArrayConcrete<char,19> spr_StringScratch37;strcpy(spr_StringScratch37._array,"T_ECK_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ']':{
         ...
         CT=T_ECK_KLAMMER_ZU;
         if(debug){
            SPRStackArrayConcrete<char,19> spr_StringScratch38;strcpy(spr_StringScratch38._array,"T_ECK_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ',':{
         ...
         CT=T_KOMMA;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch39;strcpy(spr_StringScratch39._array,"T_KOMMA");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ':':{
         ...
         CT=T_DOPPEL_PUNKT;
         if(debug){
            SPRStackArrayConcrete<char,16> spr_StringScratch3a;strcpy(spr_StringScratch3a._array,"T_DOPPEL_PUNKT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '|':{
         ...
         CT=T_PIPE;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch3b;strcpy(spr_StringScratch3b._array,"T_PIPE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '+':{
         ...
         CT=T_PLUS;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch3c;strcpy(spr_StringScratch3c._array,"T_PLUS");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '@':{
         ...
         CT=T_AT;
         if(debug){
            SPRStackArrayConcrete<char,6> spr_StringScratch3d;strcpy(spr_StringScratch3d._array,"T_AT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '.':{
         ...
         CT=T_PUNKT;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch3e;strcpy(spr_StringScratch3e._array,"T_PUNKT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '-':{
         ...
         CT=T_MINUS;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch3f;strcpy(spr_StringScratch3f._array,"T_MINUS");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ';':{
         ...
         CT=T_SEMI;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch40;strcpy(spr_StringScratch40._array,"T_SEMI");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '*':{
         ...
         CT=T_MAL;
         if(debug){
            SPRStackArrayConcrete<char,7> spr_StringScratch41;strcpy(spr_StringScratch41._array,"T_MAL");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '/':{
         ...
         CT=T_DURCH;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch42;strcpy(spr_StringScratch42._array,"T_DURCH");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '\n':{
         ...
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch43;strcpy(spr_StringScratch43._array,"T_NEUE_ZEILE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '"':{
         ...
         if(debug){
            SPRStackArrayConcrete<char,16> spr_StringScratch45;strcpy(spr_StringScratch45._array,"T_ZEICHENKETTE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '0':case '1':case '2':case '3':case '4':case '5':case '6':case '7':case '8':case '9':{
         ...
         do{
            if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
               ...
               CT=T_ZAHL;
               if(debug){
                  SPRStackArrayConcrete<char,8> spr_StringScratch46;strcpy(spr_StringScratch46._array,"T_ZAHL");
         ...
         CT=T_ZAHL;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch47;strcpy(spr_StringScratch47._array,"T_ZAHL");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   ...
   CT=T_DATEI_ENDE;
   if(debug){
      SPRStackArrayConcrete<char,14> spr_StringScratch49;strcpy(spr_StringScratch49._array,"T_DATEI_ENDE");
      if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
