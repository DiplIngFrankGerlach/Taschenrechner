...
Scanner::Scanner(char* stackStartPtr,SPRSmartPtr<SPRFile> eingabeDatei_i){
   ...
   dateiVollGelesen=0;
   SPRStackArrayConcrete<char,2> spr_StringScratch5f;strcpy(spr_StringScratch5f._array,"");
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   tokenWert=::new String_16(stackStartPtr,spr_StringScratch5f);
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
...
Scanner::Scanner(char* stackStartPtr,SPRSmartPtr<String_16> quellei){
   ...
   quelle=quellei;
   dateiVollGelesen=0;
   SPRStackArrayConcrete<char,2> spr_StringScratch60;strcpy(spr_StringScratch60._array,"");
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   tokenWert=::new String_16(stackStartPtr,spr_StringScratch60);
   leseZeiger=0;
   CT=T_UNGUELTIG;
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
...
enum Token Scanner::nextToken(char* stackStartPtr){
   ...
   do{
      if(this->istLeerzeichen(stackStartPtr,aktuellesZeichen)==1){
         if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
            ...
            CT=T_DATEI_ENDE;
            if(debug){
               SPRStackArrayConcrete<char,14> spr_StringScratch62;strcpy(spr_StringScratch62._array,"T_DATEI_ENDE");
   ...
   if(aktuellesZeichen==13){
      ...
      if(aktuellesZeichen=='\n'){
         ...
         CT=T_NEUE_ZEILE;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch64;strcpy(spr_StringScratch64._array,"T_NEUE_ZEILE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      {
      SPRStackArrayConcrete<char,40> spr_StringScratch65;strcpy(spr_StringScratch65._array,"einzelnes \\r gefunden. Beende Scanner");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   ...
   switch(aktuellesZeichen){
      case 'a':case 'b':case 'c':case 'd':case 'e':case 'f':case 'g':case 'h':case 'i':case 'j':case 'k':case 'l':case 'm':case 'n':case 'o':case 'p':case 'q':case 'r':case 's':case 't':case 'u':case 'v':case 'w':case 'x':case 'y':case 'z':case 'A':case 'B':case 'C':case 'D':case 'E':case 'F':case 'G':case 'H':case 'I':case 'J':case 'K':case 'L':case 'M':case 'N':case 'O':case 'P':case 'Q':case 'R':case 'S':case 'T':case 'U':case 'V':case 'W':case 'X':case 'Y':case 'Z':{
         ...
         do{
            if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
               ...
               CT=T_WORT;
               if(debug){
                  SPRStackArrayConcrete<char,8> spr_StringScratch67;strcpy(spr_StringScratch67._array,"T_WORT");
         ...
         CT=T_WORT;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch68;strcpy(spr_StringScratch68._array,"T_WORT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '(':{
         ...
         CT=T_KLAMMER_AUF;
         if(debug){
            SPRStackArrayConcrete<char,15> spr_StringScratch69;strcpy(spr_StringScratch69._array,"T_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ')':{
         ...
         CT=T_KLAMMER_ZU;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch6a;strcpy(spr_StringScratch6a._array,"T_KLAMMER_ZU");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '[':{
         ...
         if(debug){
            SPRStackArrayConcrete<char,19> spr_StringScratch6b;strcpy(spr_StringScratch6b._array,"T_ECK_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ']':{
         ...
         CT=T_ECK_KLAMMER_ZU;
         if(debug){
            SPRStackArrayConcrete<char,19> spr_StringScratch6c;strcpy(spr_StringScratch6c._array,"T_ECK_KLAMMER_AUF");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ',':{
         ...
         CT=T_KOMMA;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch6d;strcpy(spr_StringScratch6d._array,"T_KOMMA");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ':':{
         ...
         CT=T_DOPPEL_PUNKT;
         if(debug){
            SPRStackArrayConcrete<char,16> spr_StringScratch6e;strcpy(spr_StringScratch6e._array,"T_DOPPEL_PUNKT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '|':{
         ...
         CT=T_PIPE;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch6f;strcpy(spr_StringScratch6f._array,"T_PIPE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '+':{
         ...
         CT=T_PLUS;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch70;strcpy(spr_StringScratch70._array,"T_PLUS");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '@':{
         ...
         CT=T_AT;
         if(debug){
            SPRStackArrayConcrete<char,6> spr_StringScratch71;strcpy(spr_StringScratch71._array,"T_AT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '.':{
         ...
         CT=T_PUNKT;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch72;strcpy(spr_StringScratch72._array,"T_PUNKT");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '-':{
         ...
         CT=T_MINUS;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch73;strcpy(spr_StringScratch73._array,"T_MINUS");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case ';':{
         ...
         CT=T_SEMI;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch74;strcpy(spr_StringScratch74._array,"T_SEMI");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '*':{
         ...
         CT=T_MAL;
         if(debug){
            SPRStackArrayConcrete<char,7> spr_StringScratch75;strcpy(spr_StringScratch75._array,"T_MAL");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '/':{
         ...
         CT=T_DURCH;
         if(debug){
            SPRStackArrayConcrete<char,9> spr_StringScratch76;strcpy(spr_StringScratch76._array,"T_DURCH");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '\n':{
         ...
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch77;strcpy(spr_StringScratch77._array,"T_NEUE_ZEILE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '"':{
         ...
         do{
            if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
               ...
               CT=T_DATEI_ENDE;
               if(debug){
                  SPRStackArrayConcrete<char,14> spr_StringScratch78;strcpy(spr_StringScratch78._array,"T_DATEI_ENDE");
         ...
         if(debug){
            SPRStackArrayConcrete<char,16> spr_StringScratch79;strcpy(spr_StringScratch79._array,"T_ZEICHENKETTE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      case '0':case '1':case '2':case '3':case '4':case '5':case '6':case '7':case '8':case '9':{
         ...
         do{
            if(this->readChar(stackStartPtr,aktuellesZeichen)<1){
               ...
               CT=T_ZAHL;
               if(debug){
                  SPRStackArrayConcrete<char,8> spr_StringScratch7a;strcpy(spr_StringScratch7a._array,"T_ZAHL");
         ...
         CT=T_ZAHL;
         if(debug){
            SPRStackArrayConcrete<char,8> spr_StringScratch7b;strcpy(spr_StringScratch7b._array,"T_ZAHL");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      ...
      default:{
         CT=T_DATEI_ENDE;
         if(debug){
            SPRStackArrayConcrete<char,14> spr_StringScratch7c;strcpy(spr_StringScratch7c._array,"T_DATEI_ENDE");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   ...
   CT=T_DATEI_ENDE;
   if(debug){
      SPRStackArrayConcrete<char,14> spr_StringScratch7d;strcpy(spr_StringScratch7d._array,"T_DATEI_ENDE");
      if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
      if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
