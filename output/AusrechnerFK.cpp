...
double AusrechnerFK::Primary(char* stackStartPtr){
   ...
   switch(t){
      ...
      case T_WORT:{
         ...
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         SPRStackArrayConcrete<char,6> spr_StringScratch1a;strcpy(spr_StringScratch1a._array,"sqrt");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         SPRStackArrayConcrete<char,5> spr_StringScratch1b;strcpy(spr_StringScratch1b._array,"abs");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         SPRStackArrayConcrete<char,4> spr_StringScratch1c;strcpy(spr_StringScratch1c._array,"ln");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if((tokVal._theObject->equals(stackStartPtr,spr_StringScratch14)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch15)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch16)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch17)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch18)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch19)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch1a)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch1b)==1)||(tokVal._theObject->equals(stackStartPtr,spr_StringScratch1c)==1)){
            String_16 funktionsTyp;
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            ...
            if(t==T_KLAMMER_AUF){
               ...
               if(t==T_KLAMMER_ZU){
                  ...
                  Math m;
                  double ret;
                  SPRStackArrayConcrete<char,7> spr_StringScratch1d;strcpy(spr_StringScratch1d._array,"sinus");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,8> spr_StringScratch1e;strcpy(spr_StringScratch1e._array,"asinus");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,9> spr_StringScratch1f;strcpy(spr_StringScratch1f._array,"cosinus");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,10> spr_StringScratch20;strcpy(spr_StringScratch20._array,"acosinus");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,5> spr_StringScratch21;strcpy(spr_StringScratch21._array,"tan");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,6> spr_StringScratch23;strcpy(spr_StringScratch23._array,"sqrt");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,4> spr_StringScratch24;strcpy(spr_StringScratch24._array,"ln");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  ...
                  SPRStackArrayConcrete<char,5> spr_StringScratch25;strcpy(spr_StringScratch25._array,"abs");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
               ...
               {
               SPRStackArrayConcrete<char,14> spr_StringScratch26;strcpy(spr_StringScratch26._array,"')' erwartet");
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
                  if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            ...
            {
            SPRStackArrayConcrete<char,14> spr_StringScratch27;strcpy(spr_StringScratch27._array,"'(' erwartet");
               if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
               if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         ...
         Math m;
         SPRStackArrayConcrete<char,4> spr_StringScratch28;strcpy(spr_StringScratch28._array,"pi");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if(tokVal._theObject->equals(stackStartPtr,spr_StringScratch28)==1){
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            return m.pi(stackStartPtr);
            
         }
         SPRStackArrayConcrete<char,3> spr_StringScratch29;strcpy(spr_StringScratch29._array,"e");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if(tokVal._theObject->equals(stackStartPtr,spr_StringScratch29)==1){
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         ...
         if(variableList.search(stackStartPtr,*(tokVal.to()),variableValue)!=1){
            SPRStackArrayConcrete<char,22> spr_StringScratch2a;strcpy(spr_StringScratch2a._array,"variable $ not found");
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
            pfc.fstr(stackStartPtr,spr_StringScratch2a).sa(stackStartPtr,tokVal).pr(stackStartPtr);
            return -1.0;
      ...
      default:{
         String_16 errm;
         SPRStackArrayConcrete<char,21> spr_StringScratch2b;strcpy(spr_StringScratch2b._array,"unerwarteter Token ");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         errm.append(stackStartPtr,spr_StringScratch2b);
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         errm.append(stackStartPtr,tokVal);
         SPRStackArrayConcrete<char,14> spr_StringScratch2c;strcpy(spr_StringScratch2c._array,"in Primary()");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         errm.append(stackStartPtr,spr_StringScratch2c);
         SPRStackArrayConcrete<char,3> spr_StringScratch2d;strcpy(spr_StringScratch2d._array,"$");
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
         pfc.fstr(stackStartPtr,spr_StringScratch2d).sa(stackStartPtr,errm).pr(stackStartPtr);
         SystemControl sc;
         if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
...
void AusrechnerFK::fehler(char* stackStartPtr,SPRStackArray<char> meldung){
   char SPR_stack_dummy_var;
   PrintfClass pfc;
   SPRStackArrayConcrete<char,3> spr_StringScratch2e;strcpy(spr_StringScratch2e._array,"$");
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   pfc.fstr(stackStartPtr,spr_StringScratch2e).sa(stackStartPtr,meldung).pr(stackStartPtr);
   SystemControl sc;
   if( MAX_STACK_SZ - (stackStartPtr-&SPR_stack_dummy_var) < __systemRuntime->_maxStackBytesNeededPerCall) overflowHandler();
   sc.exit(stackStartPtr);
